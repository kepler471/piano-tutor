...
export const GUIDE_STAGES: GuideStage[] = [
    ...
    theory: [
      {
        ...
        body:
          ...
          'and black-key scales can wait until a piece needs them.',
        links: [
  ...
  },
  {
    ...
    technique: [
      ...
      lesson('scale-A-melodic-minor', 'A melodic minor scale'),
      lesson('scale-D-melodic-minor', 'D melodic minor scale'),
      lesson('chromatic-C', 'Chromatic scale from C'),
      lesson('contrary-C-major', 'C major in contrary motion'),
      lesson('contrary-G-major', 'G major in contrary motion'),
      lesson('arpeggio-Bb-major', 'B♭ major arpeggio (black-key root)'),
  ...
  },
  {
    ...
    technique: [
      ...
      lesson('scale-E-melodic-minor', 'E melodic minor scale'),
      lesson('chromatic-A', 'Chromatic scale from A'),
      lesson('contrary-E-major', 'E major in contrary motion'),
      lesson('arpeggio-Db-major', 'D♭ major arpeggio'),
      lesson('arpeggio-F#-minor', 'F♯ minor arpeggio'),
